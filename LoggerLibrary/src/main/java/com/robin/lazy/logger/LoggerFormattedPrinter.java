 ...
 */
final class LoggerFormattedPrinter implements Printer {
	...
	public void d(Throwable throwable, String message, Object... args) {
		log(LogLevel.DEBUG, resetMessage(throwable, message), args);
	}
	...
	public void e(Throwable throwable, String message, Object... args) {
		log(LogLevel.ERROR, resetMessage(throwable, message), args);
	}
	...
	public void w(Throwable throwable, String message, Object... args) {
		log(LogLevel.WARN, resetMessage(throwable, message), args);
	}
	...
	public void i(Throwable throwable, String message, Object... args) {
		log(LogLevel.INFO, resetMessage(throwable, message), args);
	}
	...
	public void v(Throwable throwable, String message, Object... args) {
		log(LogLevel.TRACE, resetMessage(throwable, message), args);
	}
	...
	public void wtf(Throwable throwable, String message, Object... args) {
		log(LogLevel.FATAL, resetMessage(throwable, message), args);
	}
	 ...
	 * @see [类、类#方法、类#成员]
	 */
	private String resetMessage(Throwable throwable, String message) {
	...
	private int getStackOffset(StackTraceElement[] trace) {
		for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
			...
			if (!name.equals(LoggerFormattedPrinter.class.getName())
					&& !name.equals(LazyLogger.class.getName())) {
				return --i;
			}
		}
		return -1;
